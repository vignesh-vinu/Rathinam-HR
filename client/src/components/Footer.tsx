        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-slate-200">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              ...
              <li className="hover:text-orange-600 transition-colors cursor-pointer">Rathinam Technical Campus (RTC)</li>
              <li className="hover:text-orange-600 transition-colors cursor-pointer">Rathinam College of Pharmacy</li>
              <li className="hover:text-orange-600 transition-colors cursor-pointer">Rathinam International School</li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              ...
              <li className="hover:text-orange-600 transition-colors cursor-pointer">Track Application Status</li>
              <li className="hover:text-orange-600 transition-colors cursor-pointer">PDF Field Mapping Standards</li>
              <li className="hover:text-orange-600 transition-colors cursor-pointer">Resume Generator</li>
            </ul>
          </div>
